#!/usr/bin/env python3
"""
PyIceberg SQLite Catalog Simple Demo
...
def main():
    print("🚀 PyIceberg SQLite Catalog Simple Demo")
    print("=" * 50)
    ...
    print("Top 10 characters from latest snapshot:")
    print(latest_data.head(10))
    
    # Step 8: Demonstrate DuckDB integration
